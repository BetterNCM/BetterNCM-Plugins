			...
			tools.makeBtn(
				...
				() =>
					betterncm.ncm.openUrl(
						"https://github.com/nexmoe/betterncm-plugin-customize#readme"
					),
				false
			),
			tools.makeBtn(
				...
				() =>
					betterncm.ncm.openUrl(
						"https://github.com/nexmoe/betterncm-plugin-customize/issues"
					),
				false
			),
			tools.makeBtn(
				...
				() =>
					betterncm.ncm.openUrl(
						"https://github.com/nexmoe/betterncm-plugin-customize/discussions"
					),
				false
			)
		)
