plugin.onAllPluginsLoaded(plugins => plugins.StylesheetLoader.loadStylesheet(
    ...
    "MoTheme",
    {
        ...
        bottomMusicBar_rainbowStrip_playback_progress: {
            name: "底部音乐栏-彩虹条颜色-播放进度：",
            key: "--MoTheme-bottomMusicBar_rainbowStrip_playback_progress",
            reflect: "cssVar",
            type: "cssInput",   // 并没有，随便写的
            default: "linear-gradient(90deg, #43CBFF, #9708CC, #FB016D)"
        },
        bottomMusicBar_rainbowStrip_volume_progress: {
            name: "底部音乐栏-彩虹条颜色-音量调节：",
            key: "--MoTheme-bottomMusicBar_rainbowStrip_volume_progress",
            reflect: "cssVar",
            type: "cssInput",   // 并没有，随便写的
            default: "linear-gradient(0deg, #43CBFF, #FB016D)"
        },
...
const owo = new MutationObserver(mutations => {
    for (const mutation of mutations) {
        ...
        } else if (!document.body.classList.contains("MoTheme-use_refinedNowPlaying")) {
